    ...
    <div className="py-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-16">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            <div className="bg-white rounded-2xl p-8 shadow">
                              <h4 className="text-2xl font-normal text-gray-800 mb-4">Khaljhuni Village</h4>
              <p className="text-lg text-gray-600 leading-relaxed mb-4">
                In Khaljhuni Village, the women have formed a group called "Mahila Milan Kendra Khaljhuni" which meets once a month to share their ideas and discuss village development.
                 ...
                 <h5 className="font-normal text-gray-800 mb-2">Impact:</h5>
                 <ul className="space-y-1 text-sm text-gray-600">
            ...
            <div className="bg-white rounded-2xl p-8 shadow">
                              <h4 className="text-2xl font-normal text-gray-800 mb-4">Bhanar Village</h4>
              <p className="text-lg text-gray-600 leading-relaxed mb-4">
                A newly constructed workshop for the local underprivileged in Bhanar Village, along with a dedicated Health Center serving the remote mountainous area.
                             ...
                             <div className="bg-gray-50 rounded-xl p-4">
                 <h5 className="font-normal text-gray-800 mb-2">Services:</h5>
                 <ul className="space-y-1 text-sm text-gray-600">
            ...
            <div className="bg-white rounded-2xl p-8 shadow">
                              <h4 className="text-2xl font-normal text-gray-800 mb-4">Kalpata Village</h4>
              <p className="text-lg text-gray-600 leading-relaxed mb-4">
                Kalpata Village and Health Center serves as a model for integrated community development, combining education and healthcare services.
                             ...
                             <div className="bg-gray-50 rounded-xl p-4">
                 <h5 className="font-normal text-gray-800 mb-2">Programs:</h5>
                 <ul className="space-y-1 text-sm text-gray-600">
            ...
            <div className="bg-white rounded-2xl p-8 shadow">
                              <h4 className="text-2xl font-normal text-gray-800 mb-4">Women's Strength Day</h4>
              <p className="text-lg text-gray-600 leading-relaxed mb-4">
        ...
        <div className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white rounded-2xl p-6 shadow">
                              <h4 className="text-lg font-normal text-gray-800 mb-3">Low-Cost Housing</h4>
            ...
            <div className="bg-white rounded-2xl p-6 shadow">
                              <h4 className="text-lg font-normal text-gray-800 mb-3">Tree Planting</h4>
            ...
            <div className="bg-white rounded-2xl p-6 shadow">
                              <h4 className="text-lg font-normal text-gray-800 mb-3">Clean Water</h4>
            ...
            <div className="bg-white rounded-2xl p-6 shadow">
                              <h4 className="text-lg font-normal text-gray-800 mb-3">Infrastructure</h4>
            ...
            <div className="bg-white rounded-2xl p-6 shadow">
                              <h4 className="text-lg font-normal text-gray-800 mb-3">Market Coordination</h4>
            ...
            <div className="bg-white rounded-2xl p-6 shadow">
                              <h4 className="text-lg font-normal text-gray-800 mb-3">Traditional Crafts</h4>
        ...
        <div className="bg-gradient-to-r from-red-600 to-red-700 rounded-3xl p-8 text-white mb-16">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            <div>
              <h3 className="text-3xl font-normal mb-6">The Role of Rural Kumaoni Women</h3>
            ...
            <div className="bg-white bg-opacity-20 rounded-2xl p-6">
                              <h4 className="text-xl font-normal mb-4">Women's Responsibilities:</h4>
        ...
        <div className="mb-16">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            <div className="bg-white rounded-2xl p-8 shadow">
                              <h4 className="text-2xl font-normal text-gray-800 mb-4">Youth Development</h4>
              <p className="text-lg text-gray-600 leading-relaxed mb-4">
            ...
            <div className="bg-white rounded-2xl p-8 shadow">
                              <h4 className="text-2xl font-normal text-gray-800 mb-4">Sustainable Development</h4>
              <p className="text-lg text-gray-600 leading-relaxed mb-4">
