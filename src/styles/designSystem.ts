export const DESIGN_SYSTEM = {
  typography: {
    heroTitle: "text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-normal mb-4 sm:mb-6",
    sectionTitle: "text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-normal mb-4 sm:mb-6", 
    subsectionTitle: "text-2xl sm:text-3xl md:text-4xl font-normal text-gray-800 mb-3 sm:mb-4 text-center",
    cardTitle: "text-lg sm:text-xl md:text-2xl font-normal text-gray-800 mb-3 sm:mb-4",
    bodyText: "text-base sm:text-lg text-gray-600 leading-relaxed",
    subtitleText: "text-base sm:text-lg md:text-xl text-gray-700 max-w-4xl mx-auto leading-relaxed font-light px-4 sm:px-0",
    statsNumber: "text-2xl sm:text-3xl md:text-4xl font-normal text-gray-800 mb-2",
